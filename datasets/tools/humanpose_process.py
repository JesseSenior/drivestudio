...
if __name__ == "__main__":
    ...
    if args.dataset == "waymo":
        from datasets.waymo.waymo_human_utils import CAMERA_LIST, project_human_boxes
        ...
        from datasets.kitti.kitti_human_utils import CAMERA_LIST, project_human_boxes
    elif args.dataset == "nuplan":
        from datasets.nuplan.nuplan_human_utils import CAMERA_LIST, project_human_boxes
    else:
        raise ValueError(
