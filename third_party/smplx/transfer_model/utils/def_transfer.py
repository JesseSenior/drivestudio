...
def read_deformation_transfer(
    ...
    ), f"Deformation transfer path does not exist: {deformation_transfer_path}"
...
def apply_deformation_transfer(def_matrix: Tensor, vertices: Tensor, faces: Tensor, use_normals=False) -> Tensor:
